...
<domain type='kvm' id='$id'>
  ...
  <devices>
    ...
    <disk type='file' device='cdrom'>
      ...
      <source file='/iso/DG8FV-B9TKY-FRT9J-6CRCC-XPQ4G.iso'/>
  ...
  <seclabel type='dynamic' model='selinux' relabel='yes'>
    <label>system_u:system_r:svirt_t:s0:c264,c933</label>
    <imagelabel>system_u:object_r:svirt_image_t:s0:c264,c933</imagelabel>
  </seclabel>
